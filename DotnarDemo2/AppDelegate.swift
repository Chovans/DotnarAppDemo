...
class AppDelegate: UIResponder, UIApplicationDelegate,NIMLoginManagerDelegate,NIMSystemNotificationManagerDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.dotnar.DotnarDemo2" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("DotnarDemo2", withExtension: "momd")!
